...
* NeoXArgs.consume_neox_args(): In the call stack deepy.py -> deepspeed -> train.py; arguments are passed to train.py by neox_args.get_deepspeed_main_args(). So produced arguments can be read with consume_neox_args() to instantiate a NeoXArgs instance.
